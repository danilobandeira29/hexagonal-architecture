...
import (
	...
	application "github.com/danilobandeira29/hexagonal-architecture/application"
...
func (m *MockProductWriterInterface) Save(p application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
...
func (mr *MockProductWriterInterfaceMockRecorder) Save(p interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockProductWriterInterface)(nil).Save), p)
}
